    ...
    <section class="mb-4">
      <div class="card">
        <div class="card-header py-3 align-items-center">
          <h5 class="mb-0 text-center"><strong>Cadastrar  Produtos</strong></h5>
        ...
        <div class="card-body">
          <div class=" d-flex align-items-center justify-content-center">
            ...
            <!-- o form vai aqui-->
            <form method="post"
              action="cadastrar-produto.php"
              enctype="multipart/form-data">
              <!-- Email input -->
              <div class="form-outline mb-4">
                <input type="texto" name="textoProduto" id="textoProduto" class="form-control" />
                <label class="form-label" for="form1Example1">Nome do Produto</label>
              </div>

              <!-- Password input -->
              <div class="form-outline mb-4">
                <input type="text" name="descProduto" id="descProduto"  class="form-control" />
                <label class="form-label" for="form1Example2">Descrição do Produto</label>
              </div>

              <!-- Selecionar Arquivos -->
              
              <label for="formFileMultiple" class="form-label">Selecione um arquivo</label>
              <input class="form-control" type="file" name="fotoProduto" id="fotoProduto" multiple />
    ...
    <section class="mb-4">
      <div class="card">
        <div class="card-header py-3">
          <h5 class="mb-0 text-center"><strong>Lista de Produtos Cadastrados</strong></h5>
        </div>
        <div class="card-body">
        <table class="table">
            <thead>
