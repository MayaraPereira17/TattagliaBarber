...
<body>
    ...
    <center> <h2 class="mb-5 text-white" ><strong> NOSSOS SERVIÇOS</strong></h2></center>
    <hr class="my-5" />
            ...
            <div class="row">
                    ...
                    foreach ($listaservico as $linha){ ?>
                                <div class="card" style="width: 18rem;" background = "black" >
                                            <img class="card-img-top" src="area-restrita/<?php echo $linha['fotosevico'] ?>" alt=""  >
                                    <div class="card-body">
                                            <h3 class="card-text"><?php echo $linha['textoservico'] ?></h3>
                                            <h2 class="card-title"><?php echo $linha['descservico'] ?></h2>
                                    </div>
                                </div>
                    <?php }?>
            </div>
